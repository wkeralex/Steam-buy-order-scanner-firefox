/**
был закоментирован js\modules\global_last.js 
функция  function createQuery2(postUrl, returnFn, postData) страница 749
функция function xHttpQuery_Post() 761
функция function tooltipDestroy(go) 881
 */
...
//старая проверка регулярное выражение
